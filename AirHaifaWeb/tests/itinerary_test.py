...
from AirHaifaWeb.pages.itinerary_page import itinerary_page
...
class itinerary_test:
    ...
    # Run Itinerary Page
    itinerary_object = itinerary_page(driver)
    itinerary_object.approval_of_the_terms()
